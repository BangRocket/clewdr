 ...
 * @param token The OAuth session token
 */
export async function validateOAuthToken(token: string): Promise<OAuthSession> {
...
/**
 * Logs out from OAuth session
 * @param token The OAuth session token
 */
export async function oauthLogout(token: string): Promise<void> {
